...
namespace owl {
    ...
    struct CallableType : public SBTObjectType {
        typedef std::shared_ptr<CallableType> SP;
        CallableType(Context* const context,
            Module::SP module,
        ...
        /*! */
        bool is_direct_callable = false;
    };

    /*! an actual instance of a miss program - defined by its type and
        variable values */
    struct Callable : public SBTObject<CallableType> {
        typedef std::shared_ptr<Callable> SP;

        /*! constructor */
        Callable(Context* const context,
    ...
    /*! get reference to given device-specific data for this object */
    inline CallableType::DeviceData& CallableType::getDD(const DeviceContext::SP& device) const
    {
